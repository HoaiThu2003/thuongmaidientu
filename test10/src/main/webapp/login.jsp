...
<body class="sub_page">
	...
	<!-- book section -->
	<section class="book_section layout_padding_login">
		<div id="logreg-forms">
			<form class="form-signin" method="post" action="login">
				...
				<h5 style="color: red; text-align: center;">${erro}</h5>
    ...
    &client_id=1089316008342-fllevmop2b90sd7mmsqotdo1neb934sg.apps.googleusercontent.com&approval_prompt=force">
						<button class="btn google-btn social-btn" style="background-color:#DF4B3B; " type="button">
							<span><i class="fab fa-google-plus-g"></i> Đăng nhập với
								Google+</span>
						</button>
					</a>
				...
				<input name="taikhoan" type="text" id="inputEmail"
					class="form-control" placeholder="username" required=""
					autofocus=""> <br><input name="matkhau" type="password"
					id="inputPassword" class="form-control" placeholder="password"
					required="">
					<br>

				<button class=" bt btn btn-success btn-block" type="submit">
					<i class="fas fa-sign-in-alt"></i> Login
				</button>
				<hr>
				<!-- <p>Don't have an account!</p>  -->
				<a class="bt btn btn-primary btn-block" href="register.jsp"><i
					class="fas fa-user-plus"></i> <fmt:message>register</fmt:message></a>
			</form>
